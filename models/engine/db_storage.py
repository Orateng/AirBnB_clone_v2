...
class DBStorage:
    ...
    def all(self, cls=None):
        """
        A query method on the current db session
        for all objects depending on the class
        and Filestorage dictionary
        """
        dct = {}
        if cls is None:
    ...
    def reload(self):
        """
        Reloads the database Session to configure a connection
        with the engine for all classes who inherit from Base
        """
